#!/usr/bin/env python3
"""
Validate the SCORER against the labeled gold set (verify the verifier).

Computes precision/recall of HARD-violation detection at the (fixture, rule_id) level
and asserts both are 1.0 — on a small curated gold set any miss or false-flag is a real
bug to fix, not noise to tolerate. Also checks that required WARN rules fire.
