...
TIMERS="bq-clickup-perf winners-refresh comments-digest research-monitor ad-rank vtt-reddit research-deepdive sha-weekly-report creative-feedback-synth gbrain-weekly raw-ingest-scan agents-weekly agents-monthly box-doctor qa-smoke night-queue-resume self-improve-digest correction-capture skill-telemetry"
