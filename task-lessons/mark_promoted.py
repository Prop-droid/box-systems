#!/usr/bin/env python3
"""Flip promoted=true for the given lesson record id(s).

Rewrites ledger.jsonl in place (temp file + atomic replace). Called by the gated
promotion step after a proposal is approved and applied to canon.

Usage:  python3 mark_promoted.py tl_1a2b3c4d tl_5e6f7a8b ...
"""
import json
import os
import sys
